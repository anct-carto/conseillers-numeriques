    ...
    methods: {
        ...
        checkPageStatus() {
            if(page_status == undefined) {
                ...
                this.bubbleRegLayer.addLayer(this.getPropSymbols(this.geom_ctr_reg, "lib_reg", "lib_reg"));
                this.bubbleDepLayer.addLayer(this.getPropSymbols(this.geom_ctr_dep, "insee_dep", "lib_dep"));
